    ...
    public class VehicleData
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Vehicle>().HasData(
                ...
                new Vehicle { Id = 3, Label = "Vehicle 3", VIN = "1HGCM82633A789456", Description = "Vehicle description 3", YearOfProductionId = 3, VehicleBrandId = 3, VehicleModelId = 3, VehicleTrimId = 2, Status = VehicleStatus.Vendu },
